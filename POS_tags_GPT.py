...
def pos_probe_linear(train_x, train_y, dev_x, dev_y, control=False):
    ...
    if control:
        torch.save(classifier, "linear_POS_GPT_control.pt")
    else:
        torch.save(classifier, "linear_POS_GPT.pt")
...
def pos_probe_non_linear(train_x, train_y, dev_x, dev_y, control=False):
    ...
    if control:
        torch.save(non_linear_classifier, "non_linear_POS_GPT_control.pt")
    else:
        torch.save(non_linear_classifier, "non_linear_POS_GPT.pt")
